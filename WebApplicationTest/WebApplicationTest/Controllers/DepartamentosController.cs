...
namespace WebApplicationTest.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var totalDeEmpleadosPrimerDepartamento= departamentos[0].Empleados.Count();
            var departamentosOtro = _context
                .Departamentos
                .Include(x => x.DepartamentoId)
                .Where(z => z.Nombre == "Tecnología")
                .Where(z => z.DepartamentoId >1)
                .Select(x => new { x.DepartamentoId, x.Nombre, TotalEmpleados = 0 }).ToList();
            var id = departamentosOtro[0].DepartamentoId;
            var name = departamentosOtro[0].Nombre;
